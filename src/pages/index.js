...
const Service = ({ service }) => {
	...
	return (
		<Grid item xs={12} md={6} style={{ height: '100%' }}>
			...
			>
				<Grid container justify="center" alignItems="center" wrap="wrap" style={{ padding: '1rem' }}>
					<Grid item xs={12}>
	...
	return (
		<Box component="section" className={classes.groupLessons}>
			<Typography variant="h5">
				We are now also offering video guitar and drum lessons, helping to honor the social distancing
				requirements to remain healthy. You may take personal, one on one sessions with your instructor on
				FaceTime, Skype or Zoom. We will email you the materials for each lesson and receive payment through
				Zelle, PayPal or Venmo at your designated time and day each week. All skill levels and ages are welcome.
			</Typography>
		</Box>
	);
};
...
const IndexPage = () => {
	...
	return (
		<Layout>
			<SEO title="Home" />
			<StyledHero>
				<Tagline tagline={site.siteMetadata.description} />
				<StyledVideoOuter>
					<SyledVideoInner>
						<StyledVideo autoPlay muted loop playsInline>
							<source src={require('../video/drums-and-guitar.mp4')} type="video/mp4" />
							<p>
